...
def generate_launch_description() -> LaunchDescription:
    pose_manifest = LaunchConfiguration('pose_manifest')
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                'pose_manifest',
                description='Absolute path to a preflighted 20+5 pose YAML.',
            ),
            DeclareLaunchArgument(
                'runtime_config',
                description=(
                    'Absolute path to the run profile anchored to the first '
                    'pose in the manifest.'
                ),
            ),
            DeclareLaunchArgument(
                'scene_path',
            ...
            DeclareLaunchArgument(
                ...
                default_value='false',
                description=(
                    'Show the MuJoCo viewer for the operator-observed run. '
            ...
            Node(
                ...
                executable='multi_pose_calibration',
                parameters=[
                    {
