...
class CommandLimits:
    ...
    def __post_init__(self) -> None:
        limits = (self.max_linear_x, self.max_linear_y, self.max_angular_z)
...
def stopped_command() -> ChassisCommand:
    return ChassisCommand(linear_x=0.0, linear_y=0.0, angular_z=0.0)
